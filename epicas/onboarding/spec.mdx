...
|----------|-------------|--------|
| Paso 1: Nombre | Campo de texto, una pregunta por pantalla, layout fullscreen | Completo |
| Paso 2: Edad | Selector de rango etario | Completo |
| Paso 3: Nivel educativo | Opciones predefinidas (radio/select) | Completo |
| Paso 4: Intereses | Multi-select con chips, copy explicativo de por qué se pide | Completo |
| Paso 5: Custom (ej: Betano) | Pregunta configurable por cliente, opciones predefinidas | Completo |
| Modal de nivelación | Modal con dos opciones: hacer nivelación (incentivada) o comenzar ya | Completo |
| Primera clase con Ada | Chat inicial donde Ada se presenta, explica TUNI y sus funcionalidades | Completo |
| Product tour | Guía interactiva de funcionalidades con pasos destacados | Completo — [TUNI-968](https://aula-educabot.atlassian.net/browse/TUNI-968), [TUNI-970](https://aula-educabot.atlassian.net/browse/TUNI-970) |
