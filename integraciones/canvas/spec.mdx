...
| Componente | Estado |
|------------|--------|
| Componente React del Chat | Completo |
| Flujo LTI 1.3 | Funcional |
| Endpoint login | Funcional |
| Endpoint launch | Funcional |
| Base de datos TUNI | Establecida |
| Obtención de access_token | Funcional |
| Lógica de comunicación con backend | Funcional |
| Widget en Canvas (inyección + bundle) | Funcional |
| Detección de contexto (materia/módulo) | Funcional |
| Widget a nivel Curso (INT-011) | Completo — [TUNI-965](https://aula-educabot.atlassian.net/browse/TUNI-965) |
| Conversación continua entre niveles (INT-013) | Completo — [TUNI-967](https://aula-educabot.atlassian.net/browse/TUNI-967) |
| Contexto home en embedded chat | Completo — [TUNI-973](https://aula-educabot.atlassian.net/browse/TUNI-973) |
| Pruebas funcionales widget para prod | Completo — [TUNI-1021](https://aula-educabot.atlassian.net/browse/TUNI-1021) |
...
- [ ] **Pantalla de sesión expirada para usuarios Canvas** (INT-014): detectar origen Canvas al expirar sesión, mostrar mensaje amigable con botón "Acceder desde Canvas" en vez del login genérico.
